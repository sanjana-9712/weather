$(document).ready(function($) {
  ...
  success : function(parsed_json) {
    ...
    document.getElementById("date1").innerHTML = arr_date[0] + " " + arr_month[0] + ", " + arr_day[0];
    document.getElementById("date2").innerHTML = arr_date[1] + " " + arr_month[1] + ", " + arr_day[1];
    document.getElementById("date3").innerHTML = arr_date[2] + " " + arr_month[2] + ", " + arr_day[2];
    document.getElementById("date4").innerHTML = arr_date[3] + " " + arr_month[3] + ", " + arr_day[3];

    document.getElementById("img1").src = arr_img[0];
    document.getElementById("img2").src = arr_img[1];
    document.getElementById("img3").src = arr_img[2];
    document.getElementById("img4").src = arr_img[3];
    ...
    document.getElementById("maxt1").innerHTML = "Max Temperature : " + arr_maxtemp[0] + "&#8451";
    document.getElementById("maxt2").innerHTML = "Max Temperature : " + arr_maxtemp[1] + "&#8451";
    document.getElementById("maxt3").innerHTML = "Max Temperature : " + arr_maxtemp[2] + "&#8451";
    document.getElementById("maxt4").innerHTML = "Max Temperature : " + arr_maxtemp[3] + "&#8451";
  
    document.getElementById("mint1").innerHTML = "Min Temperature : " + arr_mintemp[0] + "&#8451";
    document.getElementById("mint2").innerHTML = "Min Temperature : " + arr_mintemp[1] + "&#8451";
    ...
    document.getElementById("prec3").innerHTML = "QPF : " + arr_prec[2] + " mm";
    document.getElementById("prec4").innerHTML = "QPF : " + arr_prec[3] + " mm";
  }
  });
});